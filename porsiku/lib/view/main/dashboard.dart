...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget _buildDashboardContent() {
    ...
    final String userName = "Abyan"; // Replace with actual user name
    final Map<String, dynamic> todayGoal = {
      'calories': {'current': 1600, 'target': 2000},
      'protein': {'current': 38, 'target': 150},
      'fat': {'current': 27, 'target': 50},
      'carbs': {'current': 81, 'target': 180},
    };
    ...
    return SingleChildScrollView(
      padding: const EdgeInsets.all(AppBorderRadius.md), // Use AppBorderRadius
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            ...
            style: TextStyle(
              fontSize: AppTexts.xl, // Use AppTexts
              fontWeight: FontWeight.bold,
              color: AppColors.black, // Use AppColors
            ),
          ),
          const SizedBox(height: AppBorderRadius.sm / 2), // Use AppBorderRadius
          Text(
            'Track your progress and stay healthy.',
            style: TextStyle(
              fontSize: AppTexts.md,
              color: AppColors.darkGrey,
            ), // Use AppTexts & AppColors
          ),
          const SizedBox(height: AppBorderRadius.lg), // Use AppBorderRadius
          SectionCard(
            title: "Today's Goal",
  ...
  Widget _buildTodayGoalContent(Map<String, dynamic> todayGoal) {
    // Content of Today's Goal, without the title and card wrapper
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(
          ...
          child: CaloriesProgressIndicator(
            currentCalories: todayGoal['calories']['current'],
            targetCalories: todayGoal['calories']['target'],
          ),
        ),
        const SizedBox(width: 16), // Gap between calories and other nutrients
        Expanded(
          flex: 3,
          child: Column(
            ...
            children: [
              NutrientProgressRow(
                title: 'Protein',
                currentValue: todayGoal['protein']['current'],
                targetValue: todayGoal['protein']['target'],
                progressColor: AppColors.red, // Example color
              ),
              const SizedBox(height: 8), // Gap between nutrient items
              NutrientProgressRow(
                title: 'Fat',
                currentValue: todayGoal['fat']['current'],
                targetValue: todayGoal['fat']['target'],
                progressColor: AppColors.green, // Example color
              ),
              const SizedBox(height: 8), // Gap between nutrient items
              NutrientProgressRow(
                title: 'Carbs',
                currentValue: todayGoal['carbs']['current'],
                targetValue: todayGoal['carbs']['target'],
                progressColor: AppColors.yellow, // Example color
              ),
            ],
          ),
        ),
